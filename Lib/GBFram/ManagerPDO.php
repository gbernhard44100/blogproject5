...
class ManagerPDO extends Manager {
    ...
    /**
     * Return from a database all the entities in a range defined by the parameters below:
     * @param int $offset : offset to apply from the global list
     * @param int $limit : quantity of entities to return
     */        
